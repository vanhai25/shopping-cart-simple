								...
								<li class="account">
									...
									<ul class="account_selection">
										<?php if(isset($_SESSION['id_user'])):?>
											<li><i class="fa fa-sign-in" aria-hidden="true"></i><?=$_SESSION['name_user']?></li>
											<?php else: ?>
							...
							<ul class="navbar_user">
								...
								<li class="checkout">
									<a href="gio-hang">
										...
										<span id="checkout_items" class="checkout_items"><?=$cart->countProduct()?></span>
									</a>
								</li>
							</ul>
